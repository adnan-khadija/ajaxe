            ...
            <form method="GET" action="MachineController">
                <fieldset>
                    ...
                    <table border="0">
                        <tr>
                            <td>Reference</td>
                            <td><input id="ref" type="text" name="ref" value=""  required="" style="width: 200px"/></td>
                        </tr>
                        <tr>
                            <td>Prix</td>
                            <td><input id="prix" type="text" name="prix" value="" required="" style="width: 200px" /></td>
                        </tr>
                        <tr>
                            <td>Marque</td>
                            <td>
                ...
                <table border="1" class="tab">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a class="bndelete" href="MachineController?op=delete&id=<%=mm.getId()%>" onclick="confirmDelete(<%= mm.getId() %>)">Supprimer</a></td>
